    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl p-5 shadow-sm space-y-4">
      ...
      <div className="flex flex-col gap-3 border-b border-slate-100 dark:border-slate-800 pb-4">
        ...
        <div className="flex gap-2 w-full flex-wrap items-center">
          ...
          <button
            onClick={fetchLogs}
            disabled={loading}
            className="flex items-center gap-1.5 px-3 py-1.5 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-xs font-medium text-slate-600 dark:text-slate-300 transition"
          >
      ...
      {loading && (
        <div className="flex justify-center items-center py-10">
          ...
          <span className="ml-2 text-sm text-slate-400">Memuat audit log...</span>
        </div>
      )}
      {!loading && fetchError && (
        <div className="flex items-center gap-2 text-rose-500 text-sm py-6 justify-center">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="space-y-1 text-xs">
                      ...
                      <div className="text-slate-500 dark:text-slate-400 font-sans break-all sm:break-normal">
                        {log.details}
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 border-t border-slate-100 dark:border-slate-800 text-xs">
              <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400">
                <span>
                  ...
                  dari{' '}
                  <strong className="text-slate-800 dark:text-slate-200 font-bold font-mono">{filteredLogs.length}</strong> log
                </span>
